...
ComponentLoader.prototype.init= function(apps,cb){

    this.apps = this.apps.concat(apps);
    this.loadComponents()
    var promise =  this.loadSettings()
    if (cb) promise.then(cb,cb)
    return promise
}
ComponentLoader.prototype.load = function() {
    ...
    var self = this;
    var seq = sequence([this.init.bind(this,apps)
...
ComponentLoader.prototype.findCommand = function(commandName) {
    var Command = this.extensionLoader.findCommand(commandName)
